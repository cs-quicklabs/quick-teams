...
ActiveRecord::Schema.define(version: 2021_09_18_052114) do
  ...
  create_table "nuggets_users", force: :cascade do |t|
    ...
    t.datetime "created_at", default: "2021-09-18 05:24:38", null: false
    t.datetime "updated_at", default: "2021-09-18 05:24:38", null: false
  end
