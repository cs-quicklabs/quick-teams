module AvatarHelper
  ...
  def display_avatar(resource, image_size, text_size, size_limit)
    if resource.avatar.attached?
      image_tag resource.avatar.variant(resize_to_limit: size_limit), class: "rounded-full object-cover #{image_size}"
    else
